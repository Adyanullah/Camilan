<div id="page4" class="page">
    ...
    <div style="width: 74%; min-height: 140px; background: rgba(217, 217, 217, 0); border-radius: 10px; border: 0.50px #999595 solid; padding: 0 0.7vw 0 0.7vw; margin-bottom: 2.1vh;">
        ...
        <div style="width: 155px">
            <span style="color: #6B6B6B; font-size: 14px; font-family: Inter; font-weight: 400; word-wrap: break-word">Babang Surabang <br> Jl. Trunojoyo No 1 Bangkalan KAB.Bangkalan 69112 JAWA TIMUR (+62)810101010101 </span>
        </div>
    </div>
