...
<form action="<?= BASEURL . 'controller/admin/editproduk.php' ?>" method="post" enctype="multipart/form-data" style="width: 70%; color:black;" class="mb-5 pb-5">
    <div class="mb-1">
    ...
    <div class="d-flex justify-content-center">
        <a href="<?= BASEURL . 'admin/listallproduk.php' ?>" class="button-submit-form mx-5 d-flex align-items-center justify-content-center" style="background-color: red;">Cancel </a>
